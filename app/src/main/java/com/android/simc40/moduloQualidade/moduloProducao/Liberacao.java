...
public class Liberacao extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths {
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            serviceRfidReader.configureReaderLayout(Liberacao.this, tagItem, read, clear, etapa, peca);
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewObra.setOnClickListener(view -> this.recreate());
    ...
    void callApiPecas(){
        ...
        new ApiPecas(this, database, this.getClass().getSimpleName(), loadingDialog, errorDialog, apiPecasCallback, obra);
    ...
    private void generateErrorlist(){
        ...
        for (Erro erro : filteredErrosMap.values()) {
            ...
            objItem4.setOnClickListener(view -> {
                ...
                intent.putExtra("dependency", (Erro) objItem3.getTag());
