...
public class Concretagem extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths {
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            serviceRfidReader.configureReaderLayout(Concretagem.this, tagItem, read, clear, etapa, peca);
        }
    };
