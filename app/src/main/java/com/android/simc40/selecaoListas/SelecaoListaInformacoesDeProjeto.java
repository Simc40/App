...
public class SelecaoListaInformacoesDeProjeto extends AppCompatActivity {
    ...
    Intent intent;
    String tag, obraUid, database, modeloUid, etapa;
    LinearLayout header;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selecao_lista_informacoes_de_projeto);
        ...
        database = sharedPrefsDatabase.getDatabase(SelecaoListaInformacoesDeProjeto.this, MODE_PRIVATE);
    ...
    private void getModeloFromDatabase(){
        ...
        reference.addListenerForSingleValueEvent (new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                errorDialog.showError(SelecaoListaInformacoesDeProjeto.this, "Erro! "+databaseError);
                reference.removeEventListener (this);
            }
        });
    }
    ...
    private void gerarRelatorioPeca() {
        ...
        for(String property: PecaProperties){
            inflateItemOnLayout(property, pecaObject.get(property), listaLayout, R.layout.custom_3_list_item_start);
        }
