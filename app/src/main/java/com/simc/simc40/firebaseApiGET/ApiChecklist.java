...
public class ApiChecklist implements DefaultErrorMessage, FirebaseChecklistPaths, FirebaseDatabaseExceptionErrorList, Etapas {
    ...
    public ApiChecklist(String uidObra, Activity activity, String database, String contextException, ModalDeCarregamento modalDeCarregamento, ModalAlertaDeErro modalAlertaDeErro, ApiChecklistCallback apiChecklistCallback, HashMap<String, String> usersMap){
    ...
    private void getChecklist(){
        try{
            ...
            reference = FirebaseDatabase.getInstance(database).getReference().child("obras").child(uidObra).child(firebaseChecklistPathFirstKey);
