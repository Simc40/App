...
public class ApiPecas implements DefaultErrorMessage, FirebaseDatabaseExceptionErrorList, QualidadeExceptionErrorList, FirebasePecaPaths, Etapas {
    ...
    public ApiPecas(Activity activity, String database, String contextException, ModalDeCarregamento modalDeCarregamento, ModalAlertaDeErro modalAlertaDeErro, ApiPecasCallback apiPecasCallback, Obra obra){
                        ...
                        for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                            ...
                            for(DataSnapshot dataSnapshot2: dataSnapshot1.getChildren()){
                                ...
                                for(DataSnapshot datasnapshot3: dataSnapshot2.getChildren()){
                                    ...
                                    pecaTreeMap.put(peca.getTag(), peca);
                                    pecaTreeMap.put(peca.getQrCode(), peca);
                                }
                            }
                        }
