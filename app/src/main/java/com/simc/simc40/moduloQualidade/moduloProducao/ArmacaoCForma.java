...
public class
ArmacaoCForma extends Fragment implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths, ReaderExceptionErrorList {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.mproducao_armacao_cforma, container, false);
    }
    ...
    void callApiPecas(){
        ...
        new ApiChecklist(((Obra) textViewObra.getTag()).getUid(), this.requireActivity(), database, this.getClass().getSimpleName(), modalDeCarregamento, modalAlertaDeErro, apiCallback, null);
