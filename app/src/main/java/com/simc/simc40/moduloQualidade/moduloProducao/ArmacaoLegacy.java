...
public class ArmacaoLegacy extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths, ReaderExceptionErrorList {
    ...
    static final String etapa = armacaoKey;
...
//            serviceRfidReader.configureReaderLayout(Armacao.this, tagItem, readCallback, clearCallback);
