...
public class ArmacaoCFormaLegacy extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths, ReaderExceptionErrorList {
...
//            serviceRfidReader.configureReaderLayout(ArmacaoCForma.this, tagItem, readCallback, clearCallback);
//        }
//    };
//
...
//            }
//        };
//        new ApiChecklist("e668d6ac-bfed-4a67-8211-b28b0f72135a",this, database, this.getClass().getSimpleName(), loadingDialog, errorDialog, apiCallback, null);
