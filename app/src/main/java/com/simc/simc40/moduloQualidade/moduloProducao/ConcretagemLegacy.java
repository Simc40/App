...
public class ConcretagemLegacy extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths, ReaderExceptionErrorList {
    ...
    static final String etapa = concretagemKey;
...
//            serviceRfidReader.configureReaderLayout(Concretagem.this, tagItem, readCallback, clearCallback);
//        }
//    };
//
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mproducao_concretagem);
