...
public class Descarga extends AppCompatActivity implements SharedPrefsExceptionErrorList, LayoutExceptionErrorList, Etapas, QualidadeExceptionErrorList, ListaLeitores, FirebasePecaPaths, FirebaseRomaneioPaths, ReaderExceptionErrorList {
    ...
    TextView goBack, textViewObra, textViewPeca, textViewMotorista, textViewVeiculo;
    DatabaseReference reference;
    static final String etapa = descargaKey;
    HashMap<String, Object> firebaseObj, carga_romaneio;
    Button read, clear;
...
//            serviceRfidReader.configureReaderLayout(Descarga.this, tagItem, readCallback, clearCallback);
//        }
//    };
...
//        bindService(sIntent, serviceConnection, 0);
        ...
        submitForm.setOnClickListener(view -> {
            ...
            try{
                ...
                carga_romaneio.put(firebaseRomaneioPathDataDescarga, data);
                ...
                if(romaneio
                        ...
                        .filter(x -> x <= etapasDePeca.indexOf(descargaKey))
                        .count() > 1){
